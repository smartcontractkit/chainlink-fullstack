...
task("withdraw-link", "Returns any LINK left in deployed contract")
  ...
  .setAction(async (taskArgs, hre) => {
    ...
    const linkTokenAddress: string = networkConfig[chainId]['linkToken'] || taskArgs.linkaddress;
    ...
    console.log('LINK balance of contract: ' + contractAddr + " is " + hre.ethers.utils.formatEther(balance));
